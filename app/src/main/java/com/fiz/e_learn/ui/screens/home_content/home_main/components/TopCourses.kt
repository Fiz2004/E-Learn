...
fun TopCourses(
    ...
    val firstBestCourse by remember { mutableStateOf(courses.sortedByDescending { it.rating }.getOrNull(0)) }
    val secondBestCourse by remember { mutableStateOf(courses.sortedByDescending { it.rating }.getOrNull(1)) }
